    ...
    <div>
      ...
      >
        ...
        >
          ...
          {/* Lane headers */}
          <div
            className="eacc-timeline-header"
            style={{
              display: "grid",
              gridTemplateColumns: "56px 1fr 1fr",
              gap: 8,
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="eacc-week-load-grid" style={{ display: "grid", gridTemplateColumns: `repeat(${WEEK_DAYS.length}, 1fr)`, gap: 12 }}>
          {WEEK_DAYS.map((d) => {
      ...
      {/* Day-by-day list */}
      <div className="eacc-week-days-grid" style={{ display: "grid", gridTemplateColumns: `repeat(${WEEK_DAYS.length}, minmax(0, 1fr))`, gap: 12 }}>
        {WEEK_DAYS.map((d) => (
          <div
            key={d.key}
            style={{
    ...
    >
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          ...
          .eacc-tabbar::-webkit-scrollbar { display: none; }
          .eacc-tabbar button {
            white-space: nowrap;
          ...
          .eacc-timeline-header {
            grid-template-columns: 1fr !important;
          }
          .eacc-timeline-header > div:first-child {
            display: none;
          }
          .eacc-timeline-row {
            grid-template-columns: 1fr !important;
          ...
          .eacc-timeline-row > div:first-child {
            display: none;
          }
          .eacc-week-load-grid {
